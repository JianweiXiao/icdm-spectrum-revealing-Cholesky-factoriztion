! MAIN PROGRAM FOR NUMERICAL EXPERIMENT C IN THE PAPER "Spectrum-Revealing Cholesky Factorization for Kernel Methods"
...
PROGRAM TEST_SRCH_C
   ...
   INTEGER, PARAMETER :: DIM = 130
   INTEGER, PARAMETER :: PARAMETER_NP = 25
   INTEGER, PARAMETER :: PARAMETER_NB = 20
   INTEGER, PARAMETER :: PARAMETER_R = 100
   INTEGER, PARAMETER :: COUNTER = 2
   REAL*8, PARAMETER :: SIGMA = 1.0
   REAL*8, PARAMETER :: G = 1.5
   REAL*8 :: TOL
   ...
   REAL*8, DIMENSION(:), ALLOCATABLE :: AKBKS1, AKBKS2, AKBKS3, AS, AKS1, AKS2, AKS3, TEMP_RESIDUAL
   INTEGER :: ISEED(4)
   INTEGER :: I, J, INFO
   ...
   WRITE (*,*) 'ACCORDING TO THE EXPERIEMNT, WE NEED THE EXTRA SWAP STRATEGY!!!'
